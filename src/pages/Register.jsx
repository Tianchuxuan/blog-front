  ...
  return (
    <PageWrapper>
      ...
      <div className="bg-white rounded-2xl shadow-card p-8 md:p-10 border border-rose-100">
        <h1 className="text-3xl font-bold mb-8 text-center bg-gradient-to-r from-rose-600 via-pink-600 to-lime-600 bg-clip-text text-transparent">Register</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="username" className="block text-neutral-700 font-semibold mb-2 flex items-center gap-2">
              <User size={18} />
              Username
            </label>
            <input
